		...
		for(Case c : finalPath)
		{
			...
			if(curDir != d)
			{
				if(finalPath.indexOf(c) != 0)
					pathstr += Cipher.cellID_To_Code(curCaseID);
				pathstr += d;
			}
			curCaseID = c.getID();
		}
		...
		for(SpellEffect SE : ss.getEffects())
		{
			...
			switch(SE.getEffectID())
			{
				case 91://Vol de Vie Eau
					inf = 150 * Utils.getMiddleJet(SE.getJet());
				break;
				...
				break;
				case 96://Dommage Eau
					inf = 100 * Utils.getMiddleJet(SE.getJet());
				break;
				...
				break;
				case 101://Retrait PA
					inf = 75 * Utils.getMiddleJet(SE.getJet());
				break;
				case 108://Soin
					inf = -(100 * Utils.getMiddleJet(SE.getJet()));
				break;
...
public class AI {
    ...
    public static void launchIA(Fighter fighter, Fight fight) {
        ...
        switch(fighter.getMob().getTemplate().getIAType()) {
	        //case 0: apply_type0(fighter, fight); return;
	        case 1: apply_type1(fighter, fight); break;
	        case 2: apply_type2(fighter, fight); break;
	        /*case 3: apply_type3(fighter, fight); break;
	        case 4: apply_type4(fighter, fight); break;
	        case 5: apply_type5(fighter, fight); break;
	        case 6: apply_type6(fighter, fight); break;*/
        default: apply_type1(fighter, fight); break;
        }
    }
	...
	private static int calculInfluence(SortStats ss,Fighter C,Fighter T)
	{
		...
		for(SpellEffect SE : ss.getEffects())
		{
			...
			switch(SE.getEffectID())
			{
				...
				break;
				case 101://retrait PA
					inf = 1000 * Utils.getMiddleJet(SE.getJet());
				break;
				case 127://retrait PM
					inf = 1000 * Utils.getMiddleJet(SE.getJet());
				break;
				case 84://vol PA
					inf = 1500 * Utils.getMiddleJet(SE.getJet());
				break;
				case 77://vol PM
					inf = 1500 * Utils.getMiddleJet(SE.getJet());
				break;
				...
				break;
				case 138://+ %Dom
					inf = -50 * Utils.getMiddleJet(SE.getJet());
				break;
