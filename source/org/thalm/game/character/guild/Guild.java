package org.thalm.game.character.guild;
...
public class Guild {
	...
	public static class GuildMember
	{
		...
		public void setAllRights(int rank,byte xp,int right)
		{
			...
			Database.UPDATE_GUILDMEMBER(this);
		}
		...
		{
			haveRight.put(Variable.G_BOOST,false);
			haveRight.put(Variable.G_RIGHT,false);
			haveRight.put(Variable.G_INVITE,false);
			haveRight.put(Variable.G_BAN,false);
			haveRight.put(Variable.G_ALLXP,false);
			haveRight.put(Variable.G_HISXP,false);
			haveRight.put(Variable.G_RANK,false);
			haveRight.put(Variable.G_POSPERCO,false);
			haveRight.put(Variable.G_COLLPERCO,false);
			haveRight.put(Variable.G_USEENCLOS,false);
			haveRight.put(Variable.G_AMENCLOS,false);
			haveRight.put(Variable.G_OTHDINDE,false);
		}
	...
	public static class Percepteur {
		...
		public Percepteur(int iD, String nom, Guild guild, ArrayList<Item> objets,
	...
	public Guild(Player owner,String name,String emblem)
	{
	...
	public void addXp(long xp)
	{
		...
		while(_xp >= World.getGuildXpMax(_lvl) && _lvl<Main.MAX_LEVEL)
			levelUp();
	}
