...
public class Condition
{
	public static boolean validConditions(Player perso,String req)
	{
		...
		{
				//Stats stuff compris
				jep.addVariable("CI", perso.getTotalStats().getEffect(Variable.STATS_ADD_INTE));
			 	jep.addVariable("CV", perso.getTotalStats().getEffect(Variable.STATS_ADD_VITA));
			 	jep.addVariable("CA", perso.getTotalStats().getEffect(Variable.STATS_ADD_AGIL));
			 	jep.addVariable("CW", perso.getTotalStats().getEffect(Variable.STATS_ADD_SAGE));
			 	jep.addVariable("CC", perso.getTotalStats().getEffect(Variable.STATS_ADD_CHAN));
			 	jep.addVariable("CS", perso.getTotalStats().getEffect(Variable.STATS_ADD_FORC));
			 	//Stats de bases
			 	jep.addVariable("Ci", perso.get_baseStats().getEffect(Variable.STATS_ADD_INTE));
			 	jep.addVariable("Cs", perso.get_baseStats().getEffect(Variable.STATS_ADD_FORC));
			 	jep.addVariable("Cv", perso.get_baseStats().getEffect(Variable.STATS_ADD_VITA));
			 	jep.addVariable("Ca", perso.get_baseStats().getEffect(Variable.STATS_ADD_AGIL));
			 	jep.addVariable("Cw", perso.get_baseStats().getEffect(Variable.STATS_ADD_SAGE));
			 	jep.addVariable("Cc", perso.get_baseStats().getEffect(Variable.STATS_ADD_CHAN));
			 	//Autre
